    ...
    foreach ($categories as $categoryid => $fields) {
        ...
        foreach ($fields as $formfield) {
            if ($formfield->is_editable()
                && $formfield->inputname != 'profile_field_address2'
                && $formfield->inputname != 'profile_field_state'
                && $formfield->inputname != 'profile_field_postalcode') { // PLATINUM EDIT - Hiding Profile Field Address 2, State and Zip from this section
