...
class restore_customcert_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // CTEC Programs.
        $paths[] = new restore_path_element('customcert_ctecprogram', '/activity/customcert/ctecprograms/ctecprogram');
    ...
    /**
     * Handles restoring a customcert_ctecprogram.
     *
     * @param stdClass $data the customcert data
     */
    protected function process_customcert_ctecprogram($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('customcert_ctecprogram', $data);
        $this->set_mapping('customcert_ctecprogram', $oldid, $newitemid);
    }
