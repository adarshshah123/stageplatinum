...
class backup_customcert_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // The CTEC Program.
        $ctecprograms = new backup_nested_element('ctecprograms');
        $ctecprogram = new backup_nested_element('ctecprogram', array('id'), array(
            'customcertid', 'ctecprogramid', 'timecreated'));
        ...
        $customcert->add_child($ctecprograms);
        $ctecprograms->add_child($ctecprogram);
        ...
        // Define CTEC Programs source.
        $ctecprogram->set_source_table('customcert_ctecprogram', array('customcertid' => backup::VAR_ACTIVITYID));
