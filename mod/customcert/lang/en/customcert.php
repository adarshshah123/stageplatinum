...
$string['programids'] = 'Enter program id';
$string['programids_help'] = 'Add the program ids that need associating with this certificate';
$string['programidsaddfields'] = 'Add another program';
$string['programs'] = 'Programs';
$string['programtime'] = 'Program time in hours';
$string['programtime_help'] = 'Enter time for the program in hours';
...
$string['ctecprograms'] = 'CTEC Programs';
$string['ctecprogramid'] = 'Program Number';
$string['ctecprogramidaddfields'] = 'Add another CTEC program';
$string['ctecprogramid_help'] = 'Add the program numbers that need associating with this certificate';
