...
function customcert_add_instance($data, $mform) {
    ...
    // Get program id data
    $programids = isset($data->programids) ? $data->programids : [];
    $programtime = isset($data->programtime) ? $data->programtime : [];
    $ctecprogramids = isset($data->ctecprogramid) ? $data->ctecprogramid : [];
    unset($data->programids);
    unset($data->programtime);
    unset($data->ctecprogramid);
    ...
    \mod_customcert\certificate::save_program_ids($data->id, $programids, $programtime);
    \mod_customcert\certificate::save_ctecprogram_ids($data->id, $ctecprogramids);
...
function customcert_update_instance($data, $mform) {
    ...
    $ctecprogramids = $data->ctecprogramid;
    unset($data->programids);
    unset($data->programtime);
    unset($data->ctecprogramid);
...
function customcert_delete_instance($id) {
    ...
    // Delete the customcert program ids.
    if (!$DB->delete_records('customcert_program_ids', ['customcertid' => $id])) {
        return false;
    }
